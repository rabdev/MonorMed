 ...
 */
public class PatientLogAnam extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        patientloganam = inflater.inflate(R.layout.fragment_patientlog, container, false);
        ...
        patientlog_rv= (RecyclerView) patientloganam.findViewById(R.id.patientlog_recyclerview);
        patientlog_add = (FloatingActionButton) patientloganam.findViewById(R.id.patientlog_add);
    ...
    public void loadANAM(String szemely_id){
        ...
        request.setOperation(Operations.PATIENT_LOG_ANAM);
        ...
        response.enqueue(new Callback<ServerResponse>() {
            ...
            public void onResponse(Call<ServerResponse> call, retrofit2.Response<ServerResponse> response) {
                ...
                adapter_plog=new com.monormed.adapters.PatientLog(data, PatientLogAnam.this);
